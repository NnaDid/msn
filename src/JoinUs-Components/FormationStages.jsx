...
>
  {[
    ...
    "Ongoing Formation: Formation is a lifetime process. Every member continues to grow academically, pastorally, spiritually, and humanly even after ordination. Ongoing formation entails docility to learning and growth."
  ].map((text, index) => (
    <Box
      key={index}
      minW="80%"
